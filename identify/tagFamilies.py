...
from identify.tagDetection import TagDetection
...
class Tagclass(object):
    ...
    def decodeQuad(self, quads, gray):
            ...
            for iy in range(dd):
                for ix in range(dd):
                    ...
                    if value > threshold:
                        ...
                        tagcode |= 1
            tagcode = hex(tagcode)
            # print("十六进制数是",tagcode)
            # print("blackvalue",blackvalue)
            # print("whitevalue",whitevalue)
        ...
        #     plt.figure().set_size_inches(10.2, 7.8)
        #     plt.subplot(121)
...
class RMTAGclass(Tagclass):
    def __init__(self,hammingdis = 2,debug = False):
        super().__init__(GLOBAL_RMTAG, 5, debug, hammingdis)
